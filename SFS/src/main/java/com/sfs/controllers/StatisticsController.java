...
// Removed: import reactor.core.publisher.Mono; 
...
public class StatisticsController {
    ...
    public ResponseEntity<Map<String, Map<Long, Duration>>> getOperationTime() {
        ...
        Map<String, Map<Long, Duration>> report =
            statisticsService.getTotalOperationTimePerDeviceByGroup();
    ...
    public ResponseEntity<Map<String, Double>> getUtilizationRate() {
        ...
        Map<String, Double> report =
            statisticsService.getUtilizationRateLast24Hours();
